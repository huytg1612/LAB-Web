<%-- 
    Document   : post_service
    Created on : Sep 28, 2019, 2:23:06 PM
    Author     : SE130226
--%>
                ...
                <div class="container">
                    <div class="row-fluid content-inner">
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper ">
                                <div class="content">
                                    <c:if test="${requestScope.POST_SERVICES != null}">
                                        <c:if test="${requestScope.POST_SERVICES.size() > 0}">
                                            <c:forEach items="${requestScope.POST_SERVICES}" var="post_service" varStatus="status">
                                                <div class="section article">
                                                    <div class="heading">
                                                        <h3>${post_service.title}</h3>
                                                    </div>
                                                    ...
                                                    <div class="content">
                                                        <c:if test="${status.count % 2 != 0}">
                                                            ...
                                                            <c:if test="${status.count % 2 == 0}">
                                                                ...
                                                                <div class="image">
                                                                    <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314541983971._szw1280h1280_.jpg"><img src="./Therapy and Massage - www.simplesite.com_us-123health_files/i283445314541983971._szw480h1280_.jpg"></a>
                                                                </div>
                                                            </div>
                                                            <p><span>${post_service.content}</span></p>    </div>
                                                    </div>             
                                                </c:forEach>
                                            </c:if>
                                        </c:if>
