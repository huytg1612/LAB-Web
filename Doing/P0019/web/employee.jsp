<%-- 
    Document   : employee
    Created on : Sep 28, 2019, 7:16:53 PM
    Author     : SE130226
--%>
                                                ...
                                                <div class="section article">
                                                    ...
                                                    <div class="content">
                                                        <div class="img-simple span3 pull-left">
                                                            <div class="image">
                                                                <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314494044460._szw1280h1280_.jpg"><img src="./Employees - www.simplesite.com_us-123health_files/i283445314494044460._szw480h1280_.jpg"></a>
                                                            </div>
                                                        </div>
                                                        <p>
                                                            <span style="font-size: 16px;">
                                                                <c:if test="${employee.list != null}">
                                                                    <c:if test="${employee.list.size() > 0}">
                                                                        <c:forEach items="${employee.list}" var="service">
                                                                            ${service.serviceName},
                                                                        </c:forEach>
                                                                    </c:if>
                                                                </c:if>
                                                        ...
                                                        <p>
                                                            <span style="font-size: 16px;" data-mce-mark="1">
