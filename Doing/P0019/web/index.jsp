<%-- 
    Document   : index
    Created on : Sep 27, 2019, 4:10:19 PM
    Author     : SE130226
--%>
...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body data-pid="118896506" data-iid="">
                                ...
                                <div class="content">
                                    <div class="section article">
                                        <div class="content">
                                            <div class="img-simple span12 ">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314524568867._szw1280h1280_.jpg"><img src="./Welcome - www.simplesite.com_us-123health_files/i283445314524568867._szw1280h1280_.jpg"></a>
                                                </div>
                                            </div>
                                                    ...
                                                    <c:if test="${requestScope.POSTS.size() > 0}">
                                                        <c:forEach items="${requestScope.POSTS}" var="post">
                                                            <li class="span4">
                                                                <div class="img-simple span12 ">
                                                                    <div class="image">
                                                                        <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314524568923._szw1280h1280_.jpg"><img src="images${post.picture}"></a>
                                                                    </div>
                                                                </div>

                                                                <h4>
                                                                    <a rel="nofollow" href="http://www.simplesite.com/us-123health/118896508">${post.title}</a>
                                                                </h4>
                                    ...
                                    <div class="section article">
                                        ...
                                        <c:if test="${requestScope.INFO != null}">
                                            <div class="content">
                                                <p>Tel: ${requestScope.INFO.tel}</p> <p><span data-mce-mark="1">Email: ${requestScope.INFO.email}</p>    </div>     
                                            </c:if>
                                    </div>
                                        ...
                                        <div class="content">
                                            <c:if test="${requestScope.EMPLOYEE != null}">
                                                <div class="img-simple span4 signature-image">
                                                    <div class="image">
                                                        <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314527777596._szw1280h1280_.jpg"><img src="./Welcome - www.simplesite.com_us-123health_files/i283445314527777596._szw480h1280_.jpg"></a>
                                                    </div>
                                                </div>
        ...
        <div id="sm2-container" class="movieContainer high_performance" style="z-index: 10000; position: fixed; width: 8px; height: 8px; bottom: 0px; left: 0px; overflow: hidden; visibility: hidden;"><embed name="sm2movie" id="sm2movie" src="/Images/sm297/soundmanager2_flash9.swf" quality="high" allowscriptaccess="always" bgcolor="#ffffff" pluginspage="www.macromedia.com/go/getflashplayer" title="JS/Flash audio component (SoundManager 2)" type="application/x-shockwave-flash" wmode="transparent" haspriority="true"></div></body>
</html>
